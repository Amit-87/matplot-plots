...
1.  Matplot_All.ipynb : It's a jupyter notebook that consists python codes to generate basic plots/graphs using 'Matplotlib' library of Python; alon with outputs.
